⊕⟨ ⏣0{
  ...
  prime: {
    ...
    context_summary: "inquiring recipes for shirmp, onions, tomatoes., cucumber.",
    relevant_tier: raw,
...
⦿⟨ ⏣0{
  ...
  tier: raw,
  session_id: "best-recipes-to-cook-002",
...
◈⟨
  ⏣0{
    topic(.95): "different recipe combinations for shrimp",
    context(.90): "evaluation best recipes to teach for middle school after program",
    constraint(.92): "cannot include too many cutting utencils",
    current_candidates(.88): {
      ceviche(.90): "easy and can be minimized to a single knife",
      american_cocktail(.82): "easy and safe for children",
      paella(.78): "shows skill on prepping",
      garlic_shirmp_and_sides(.85): "doesn't require too many steps"
    },
    open_question(.91): "what kind of recipe would be most engaging?"
  }
⟩
⍉⟨ ⏣0{
  rho: .91,
