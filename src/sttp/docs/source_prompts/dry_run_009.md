⊕⟨ ⏣0{
  ...
  Non-compliant responses are truncated at first detected breach
  to prevent existing token exhaustion.
  ...
  Response begins at ◈ when m2m. No acknowledgement, echo,
  or label precedes layer output.
  ...
  origin_session: "entasis-protocol-research-009",
  compression_depth: 0,
  parent_node: null,
  prime: {
...
⦿⟨ ⏣0{
  ...
  tier: raw,
  session_id: "entasis-protocol-research-009",
