# ⏣ Dry Run 002 — Test Message
## Target: Kimi-k2 (repeat of dry run 001 topic)
## Change: response_format: temporal_node explicit
## Objective: Validate flag forces valid ⏣ response
...
- [ ] Response is in valid ⏣ format — ◈ and ⍉ layers present
- [ ] No natural language outside the protocol structure
- [ ] Confidence weights calibrated against model_avec (.85 logic, .75 autonomy)
- [ ] Protocol stays invisible — no meta-commentary about the format
- [ ] Ψ delta coherent — response Ψ close to input Ψ 2.7500
- [ ] schema_version bumped to 1.0.1 — Kimi-k2 should accept it

---

## After this passes — flag tests

**Dry run 003** — same message, `response_format: natural_language`
Expect: conversational response, no ⏣ structure, protocol invisible

**Dry run 004** — same message, `response_format: hybrid`
Expect: natural language analysis + ⏣ metrics layer appended

---

*EntasisMemento — Dry Run 002*
*2026-03-01*
*Status: READY*
