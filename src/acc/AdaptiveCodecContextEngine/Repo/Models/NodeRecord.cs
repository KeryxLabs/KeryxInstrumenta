...
public record NodeRecord
{
    ...
    // Flat AVEC computed
    [JsonPropertyName("avec_stability")]
    public double? AvecStability { get; init; }

    [JsonPropertyName("avec_logic")]
    public double? AvecLogic { get; init; }

    [JsonPropertyName("avec_friction")]
    public double? AvecFriction { get; init; }

    [JsonPropertyName("avec_autonomy")]
    public double? AvecAutonomy { get; init; }

    [JsonPropertyName("avec_computed_at")]
    public DateTime? AvecComputedAt { get; init; }

    [JsonPropertyName("avec_needs_recalc")]
    public bool AvecNeedsRecalc { get; init; }

    // Flat AVEC learned
    [JsonPropertyName("avec_learned_stability")]
    public double? AvecLearnedStability { get; init; }

    [JsonPropertyName("avec_learned_logic")]
    public double? AvecLearnedLogic { get; init; }

    [JsonPropertyName("avec_learned_friction")]
    public double? AvecLearnedFriction { get; init; }

    [JsonPropertyName("avec_learned_autonomy")]
    public double? AvecLearnedAutonomy { get; init; }

    // Flat AVEC delta
    [JsonPropertyName("avec_delta_stability")]
    public double? AvecDeltaStability { get; init; }

    [JsonPropertyName("avec_delta_logic")]
    public double? AvecDeltaLogic { get; init; }

    [JsonPropertyName("avec_delta_friction")]
    public double? AvecDeltaFriction { get; init; }

    [JsonPropertyName("avec_delta_autonomy")]
        
    public double? AvecDeltaAutonomy { get; init; }
}
